...
M=	    \left\{ x\in B: F(x)=F(a) \right\}
	  ...
	  \begin{equation*}
	    \partial C= \sum_{i=1}^k (-1)^i (F_i C - B_i C).
	  \end{equation*}
	  \begin{prop}
